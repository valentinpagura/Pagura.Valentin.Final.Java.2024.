...
//
//         Importar desde JSON
//        gestor.importarJSON("productos.json");
//        System.out.println("Productos importados desde 'productos.json' con éxito!!!");
//
//         Mostrar los productos importados
//        System.out.println("Lista de productos importados:");
//        for (Producto producto : gestor.leer()) {
